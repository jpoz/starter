...
func newSchemaMigration(db *gorm.DB, opts ...gen.DOOption) schemaMigration {
	...
	_schemaMigration.schemaMigrationDo.UseModel(&models.SchemaMigration{})
...
type ISchemaMigrationDo interface {
	...
	Create(values ...*models.SchemaMigration) error
	CreateInBatches(values []*models.SchemaMigration, batchSize int) error
	Save(values ...*models.SchemaMigration) error
	First() (*models.SchemaMigration, error)
	Take() (*models.SchemaMigration, error)
	Last() (*models.SchemaMigration, error)
	Find() ([]*models.SchemaMigration, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.SchemaMigration, err error)
	FindInBatches(result *[]*models.SchemaMigration, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.SchemaMigration) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.SchemaMigration, error)
	FirstOrCreate() (*models.SchemaMigration, error)
	FindByPage(offset int, limit int) (result []*models.SchemaMigration, count int64, err error)
...
func (s schemaMigrationDo) Create(values ...*models.SchemaMigration) error {
	if len(values) == 0 {
		return nil
	}
...
func (s schemaMigrationDo) CreateInBatches(values []*models.SchemaMigration, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s schemaMigrationDo) Save(values ...*models.SchemaMigration) error {
	if len(values) == 0 {
		return nil
	}
...
func (s schemaMigrationDo) First() (*models.SchemaMigration, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.SchemaMigration), nil
	}
}

func (s schemaMigrationDo) Take() (*models.SchemaMigration, error) {
...
func (s schemaMigrationDo) Last() (*models.SchemaMigration, error) {
...
func (s schemaMigrationDo) Find() ([]*models.SchemaMigration, error) {
	result, err := s.DO.Find()
	return result.([]*models.SchemaMigration), err
}

func (s schemaMigrationDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.SchemaMigration, err error) {
	buf := make([]*models.SchemaMigration, 0, batchSize)
...
func (s schemaMigrationDo) FindInBatches(result *[]*models.SchemaMigration, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s schemaMigrationDo) FirstOrInit() (*models.SchemaMigration, error) {
...
func (s schemaMigrationDo) FirstOrCreate() (*models.SchemaMigration, error) {
...
func (s schemaMigrationDo) FindByPage(offset int, limit int) (result []*models.SchemaMigration, count int64, err error) {
...
func (s schemaMigrationDo) Delete(models ...*models.SchemaMigration) (result gen.ResultInfo, err error) {
